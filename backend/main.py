...
async def seed_demo_users():
    ...
    demo_users = [
        {"id": "demo-user-1", "name": "Pranav",  "email": "pranav@tradelab.app", "password": "***REMOVED***"},
        {"id": "demo-user-2", "name": "Mithil",  "email": "mithil@tradelab.app", "password": "***REMOVED***"},
        {"id": "demo-user-3", "name": "Supreeth",   "email": "supreeth@tradelab.app", "password": "***REMOVED***"},
    ]
